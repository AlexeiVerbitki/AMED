...
@Component({
  selector: 'app-substanta-aux',
  templateUrl: './substanta-aux.component.html',
  styleUrls: ['./substanta-aux.component.css']
})
export class SubstantaAuxComponent implements OnInit {
  displayedColumns: any[] = ['id', 'cod', 'description', 'action'];
  dataSource = new MatTableDataSource<Bank>(ELEMENT_DATA);

  visibility: boolean = false;
  title: string = 'Substanta aux';
