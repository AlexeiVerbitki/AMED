...
@Component({
  selector: 'app-price-expiration-reasons',
  templateUrl: './price-expiration-reasons.component.html',
  styleUrls: ['./price-expiration-reasons.component.css']
})
export class PriceExpirationReasonsComponent implements OnInit {
