...
@Component({
  selector: 'app-types-of-customs-transactions',
  templateUrl: './types-of-customs-transactions.component.html',
  styleUrls: ['./types-of-customs-transactions.component.css']
})
export class TypesOfCustomsTransactionsComponent implements OnInit {
