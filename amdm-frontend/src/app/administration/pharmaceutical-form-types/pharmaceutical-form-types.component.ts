...
@Component({
  selector: 'app-pharmaceutical-form-types',
  templateUrl: './pharmaceutical-form-types.component.html',
  styleUrls: ['./pharmaceutical-form-types.component.css']
})
export class PharmaceuticalFormTypesComponent implements OnInit {
  displayedColumns: any[] = ['id', 'description', 'action'];
  dataSource = new MatTableDataSource<Bank>(ELEMENT_DATA);

  visibility: boolean = false;
  title: string = 'Pharmaceutical form types';
