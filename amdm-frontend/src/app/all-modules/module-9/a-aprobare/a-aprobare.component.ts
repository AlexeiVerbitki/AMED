...
export class AAprobareComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.navbarTitleService.showTitleMsg('Aprobare studiu clinic');
    ...
    initPage() {
        this.subscriptions.push(this.activatedRoute.params.subscribe(params => {
            this.subscriptions.push(this.requestService.getClinicalTrailRequest(params['id']).subscribe(data => {
                    ...
                    this.approveClinicalTrailForm.get('registrationRequestMandatedContacts').setValue(data.registrationRequestMandatedContacts);
    ...
    onSubmit() {
        ...
        if (formModel.status === '0') {
            ...
            dialogRef2.afterClosed().subscribe(result => {
                ...
                if (result) {
                    this.loadingService.show();
                    // const formModel2 = this.approveClinicalTrailForm.getRawValue();
