...
@Component({
    selector: 'app-view-authorization-dialog',
    templateUrl: './view-authorization-dialog.html',
    styleUrls: ['./view-authorization-dialog.css']
})
export class ViewAuthorizationDialog implements OnInit, OnDestroy {
    cereri: Cerere[] = [];
    ...
    constructor(private fb: FormBuilder,
                ...
                public dialog: MatDialogRef<ViewAuthorizationDialog>,
    ...
    ngOnInit() {
        ...
        this.evaluateImportForm = this.fb.group({
            'importAuthorizationEntity': this.fb.group({
                'unitOfImportTable': this.fb.group({
                    ...
                    approvedQuantity: [{value: null, disabled: true}],
        ...
        if (this.dialogData.medicament) {
            ...
            const quantityValid = this.dialogData.quantity != undefined;
            const approvedQuantityValid = this.dialogData.approvedQuantity != undefined;
            const priceValid = this.dialogData.price != undefined;
            const currencyValid = this.dialogData.currency && this.dialogData.currency.shortDescription;
            ...
            const approvedQuantityValid = this.dialogData.approvedQuantity != undefined;
            const priceValid = this.dialogData.price  != undefined;
            const shortDescriptionValid = this.dialogData.currency && this.dialogData.currency.shortDescription;
