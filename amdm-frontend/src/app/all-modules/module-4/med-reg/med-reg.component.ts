            ...
            for ( let R: number  = range.s.r+8; R <= range.e.r; R++) {
                ...
                for (let C = 1; C < columns.length; C++) {
                    ...
                    if (!sheet[cellref]) {
                        ...
                        switch (C) {
                            case  1: { cell.v ? rowToBeParsed.codeAmed =          cell.v.toString() : rowToBeParsed.codeAmed= null; /*if(!rowToBeParsed.codeAmed || rowToBeParsed.codeAmed == undefined)                {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
                            case  2: {rowToBeParsed.customsCode =                 cell.v.toString(); /*if(!rowToBeParsed.customsCode || rowToBeParsed.customsCode == undefined)                                 {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
                            ...
                            case  5: {rowToBeParsed.dose =                        cell.v.toString(); /*if(!rowToBeParsed.dose || rowToBeParsed.dose == undefined)                                               {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
                            ...
                            case  7: {rowToBeParsed.quantity =                    Number(cell.v);/*if(!rowToBeParsed.quantity || rowToBeParsed.quantity == undefined)                                       {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
                            case  8: {rowToBeParsed.price =                       Number(cell.v);/*if(!rowToBeParsed.price || rowToBeParsed.price == undefined)                                             {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
                            case  9: {rowToBeParsed.summ =                        Number(cell.v);/*if(!rowToBeParsed.summ || rowToBeParsed.summ == undefined)                                               {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
                            ...
                            case 12: {rowToBeParsed.registrationNumber =          cell.v.toString(); /*if(!rowToBeParsed.registrationNumber || rowToBeParsed.registrationNumber == undefined)                   {console.log(columns[C] + cellNumber +": contine greseli")}*/; break;}
