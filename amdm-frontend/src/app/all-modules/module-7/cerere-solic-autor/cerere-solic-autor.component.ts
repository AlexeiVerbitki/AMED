...
export class CerereSolicAutorComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private administrationService: AdministrationService,
   ...
   ngOnInit() {
      ...
      this.subscriptions.push(this.activatedRoute.params.subscribe(params => {
              this.subscriptions.push(this.requestService.getMedicamentRequest(params['id']).subscribe(data => {
                      ...
                      this.cerereSolicAutorForm.get('medicament.name').setValue(data.medicamentName);
                      this.cerereSolicAutorForm.get('medicamentName').setValue(data.medicamentName);
                      ...
                      this.cerereSolicAutorForm.get('medicaments').setValue(data.medicaments);
                      ...
                      if(data.medicaments != null && data.medicaments[0] && data.medicaments[0].experts != null){
                             this.subscriptions.push(
                                  this.administrationService.getEmployeeById(data.medicaments[0].experts.chairman.id).subscribe(data => {
                                      this.cerereSolicAutorForm.get('employee.name').setValue(data.name);
                                      this.cerereSolicAutorForm.get('employee.lastname').setValue(data.lastname);
                                      this.cerereSolicAutorForm.get('employee.idnp').setValue(data.idnp);
                                      this.cerereSolicAutorForm.get('employee.email').setValue(data.email);
                                      this.cerereSolicAutorForm.get('employee.phonenumbers').setValue(data.phonenumbers);
                                      },
                          error => {
   ...
   saveRequest() {
      ...
      console.log(this.cerereSolicAutorForm.value);
